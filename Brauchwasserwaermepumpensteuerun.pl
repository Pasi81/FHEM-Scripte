*00:04:00 {
	...
	# Lese Werte
	my $ForecastProd = ReadingsVal($ForecastDev,"RestOfDayPVforecast", "0");

	my $PVBatSOC = ReadingsVal($PVBatterieDev,"BatteryChargePercent", "10");
	my $PVBatRese = ReadingsVal($PVBatterieDev,"BatConfigReserve", "10");
	my $PVBatCapa = ReadingsVal($PVBatterieDev,"BatteryCapacity", "10");
